            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('store.updater', $store['id']) }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    @if ($store->photo)
                                        <img height="350" width="350" src="{{ asset('storage/' . $store->photo) }}" alt="Предыдущее фото">
                                    @endif
